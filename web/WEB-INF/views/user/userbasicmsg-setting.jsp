            ...
            <div class="row">
                ...
                <div class="col-md-8" id="register_content">
                    ...
                    <small class="text-muted m-b">
                        <form action="${ctx}/user/changemsg" class="bs-example form-horizontal" id="register_form"  method="post" enctype="multipart/form-data" onsubmit="return check(this)">

                            <div class="form-group">

                                <label class="col-lg-2 col-md-2 control-label" for="photos">更换头像：</label>
                            ...
                            <div class="form-group" style="display: none">
                                ...
                                <div class="col-lg-9 col-md-9">
                                    <input type="password" name="password" id="password"  title="密码" class="form-control" value="${currentUser.password}" placeholder="请填写密码" required="required">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9 col-md-9">
                                    <input type="email" name="email" id="email" class="form-control"  title="邮箱" placeholder="请输入常用邮箱" required="required" value="${currentUser.email}">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9 col-md-9">
                                    <input type="text" name="name" id="name" class="form-control"  title="真实姓名" placeholder="请输入您的真实姓名" value="${currentUser.name}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9 col-md-9">
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="sex" id="optionsRadios1" value="1" ${currentUser.sex eq 1? 'checked':''}>男
                                        </label>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <label>
                                            <input type="radio" name="sex" id="optionsRadios2" value="0" ${currentUser.sex eq 0? 'checked':''}>女
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9 col-md-9">
                                    <input type="text" name="qq" id="qq"  title="QQ号码" class="form-control" placeholder="请填写QQ" value="${currentUser.qq}">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9 col-md-9">
                                    <input type="text" name="tel" id="tel"  title="手机号码" class="form-control" placeholder="请填写手机号码" value="${currentUser.tel}">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9 col-md-9">
                                    <textarea name="info" id="info" class="form-control"  title="个人简介" placeholder="请填写个人介绍" rows="4"> ${currentUser.info}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-lg-offset-2 col-lg-9 col-md-offset-2 col-md-9">
                                    <button type="submit" id="register_sumbit" class="btn btn-primary text-right">保存修改</button>
                                </div>
                            </div>
                        </form>
                    </small>
