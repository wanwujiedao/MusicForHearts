    ...
    <div class="row" id="content">
        <div class="vbox col-md-8 col-md-offset-2" style="margin-top: 50px">
            ...
            <small class="text-muted m-b">
                <form action="${ctx}/noticy/update" class="bs-example form-horizontal" id="noticy_form" method="post"
                      onsubmit="return check(this)">

                    <input type="hidden" name="id" value="${noticy.id}"/>

                    <div class="form-group">
                        <label id="name_label" class="col-lg-2 col-md-2 control-label" for="title">公告标题：</label>

                        <div class="col-lg-9 col-md-9">
                            <input type="text" name="title" id="title" class="form-control" value="${noticy.title}"
                                   required="required" title="公告标题" placeholder="请输入公告标题"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9 col-md-9 myselect">
                            <input type="text" name="targetname" id="targetname" class="form-control"
                                   placeholder="请选择目标" value="${noticy.targetname}" readonly/>
                            <input type="hidden" name="target" id="target" value="${noticy.target}"/>
                            ...
                            <div class="userlist">
                                ...
                                <div style="border-top:1px solid #000;" class="changepage"><a
                                        class="dao-btn pre"></a><span class="page"></span><a class="dao-btn next"></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9 col-md-9">
                            <textarea style="height: 80px" name="notice" id="notice" class="form-control"
                                      required="required" title="公告内容" placeholder="请输入公告内容">${noticy.notice}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-2 col-lg-9 col-md-offset-2 col-md-9">
                            ...
                            <button type="submit" class="btn btn-success text-right">修改</button>
