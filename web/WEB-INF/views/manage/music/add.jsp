            ...
            <div class="row">
                ...
                <div class="col-md-8 col-md-offset-2" id="music_content">
                    ...
                    <div class="clearfix text-center m-t">
                        <div class="inline">
                            <div class="easypiechart" data-percent="75" data-line-width="5" data-bar-color="#4cc0c1"
                                ...
                                <div class="thumb-lg">
                                    <img src="/sources/useravatar/default_avatar.png" class="img-circle" id="imgpre"
                    ...
                    <small class="text-muted m-b">
                        <form action="${ctx}/music/insertMusic" class="bs-example form-horizontal" id="music_form" method="post"
                              enctype="multipart/form-data" onsubmit="return check(this)">

                            <div class="form-group">

                                <label class="col-lg-2 col-md-2 control-label" for="music">音乐资源：</label>

                                <div class="col-lg-9 col-md-9">
                                    <input type="file" class="filestyle" name="music" id="music"
                                           data-classButton="btn btn-default"
                                           data-classInput="form-control inline v-middle input-s" required="required">
                                </div>
                            </div>

                            <div class="form-group">

                                <label class="col-lg-2 col-md-2 control-label" for="photos">音乐封面：</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9 col-md-9">
                                    <input type="text" name="name" id="name" class="form-control" title="音乐名称"
                                           placeholder="请填写音乐名称" required="required">
                                </div>
                            ...
                            <div class="form-group artists">
                                ...
                                <div class="col-lg-9 col-md-9  myselect">
                                    <input type="text" name="artistname" value="未知" id="artistname" class="form-control"
                                           title="歌手名称" placeholder="请输入歌手名称" readonly>
                            ...
                            <div class="form-group albums">
                                ...
                                <div class="col-lg-9 col-md-9">
                                    <input type="text" name="albumname" id="albumname" value="无" class="form-control"
                                           title="所属专辑"
                                           placeholder="请选择所属专辑" readonly>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9 col-md-9">
                                    <textarea type="text" name="info" id="info" class="form-control" title="音乐简介"
                                              placeholder="请输入音乐简介"></textarea>
                                </div>
                            </div>

                            <div class="form-group">
                                <div class="col-lg-offset-2 col-lg-9 col-md-offset-2 col-md-9">
                                    <button type="submit" id="register_sumbit" class="btn btn-primary text-right">添加音乐
                                    </button>
